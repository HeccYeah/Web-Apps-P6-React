...
namespace Project5.Controllers
{
    public class CatalogsController : Controller
    {
        ...
        public CatalogsController(Project5Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Catalog != null ? 
                          ...
                          Problem("Entity set 'Project5Context.Catalog'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,cat_year")] Catalog catalog)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,cat_year")] Catalog catalog)
        {
            if (id != catalog.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Project5Context.Catalog'  is null.");
            }
            var catalog = await _context.Catalog.FindAsync(id);
            if (catalog != null)
            {
